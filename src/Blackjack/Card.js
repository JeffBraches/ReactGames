...
class Card extends Component {
        ...
        if (this.props.card === -1){
            ...
            switch(cardValue){
                case -2:
                    ...
                    break;
                case 0:
                    cardUrl = cardUrl = cardUrl.concat('ace_of_')
                    break;
                case 1:
                    cardUrl = cardUrl = cardUrl.concat('2_of_')
                    break;
                case 2:
                    cardUrl = cardUrl = cardUrl.concat('3_of_')
                    break;
                case 3:
                    cardUrl = cardUrl = cardUrl.concat('4_of_')
                    break;    
                case 4:
                    cardUrl = cardUrl = cardUrl.concat('5_of_')
                    break;
                case 5:
                    cardUrl = cardUrl = cardUrl.concat('6_of_')
                    break;
                case 6:
                    cardUrl = cardUrl = cardUrl.concat('7_of_')
                    break;
                case 7:
                    cardUrl = cardUrl = cardUrl.concat('8_of_')
                    break;
                case 8:
                    cardUrl = cardUrl = cardUrl.concat('9_of_')
                    break;
                case 9:
                    cardUrl = cardUrl = cardUrl.concat('10_of_')
                    break;
                case 10:
                    cardUrl = cardUrl = cardUrl.concat('jack_of_')
                    break;
                case 11:
                    cardUrl = cardUrl = cardUrl.concat('queen_of_')
                    break;
                case 12:
                    cardUrl = cardUrl = cardUrl.concat('king_of_')
                    break;
            }

            switch(cardSuit){
                case 0:
                    cardUrl = cardUrl = cardUrl.concat('clubs.png')
                    break;
                case 1:
  ...
  render() {
    return (
      <img className='card' src={this.state.cardSource}></img>
    );
  }
}
