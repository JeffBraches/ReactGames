...
class GameContainer extends Component {
    ...
    handleHit(){
        ...
        if (this.state.playerCard3 === -1){
            this.setState({playerCard3: newCard, deck: cardDeck}, this.calculatePlayerHand)
        } else if (this.state.playerCard4 === -1) {
            this.setState({playerCard4: newCard, deck: cardDeck}, this.calculatePlayerHand)
        } else if (this.state.playerCard5 === -1) {
            this.setState({playerCard5: newCard, deck: cardDeck}, this.calculatePlayerHand)
        }
    ...
    handleStay(){
        ...
        if (dealerHandValue > 21){
            ...
            //dealer win
            this.setState({
                result: "Loss - Dealer has "+dealerHandValue+" and player has "+playerHandValue,
                dealerCard2: this.state.dealerHidden,
                gameState: 2
            })
            ...
            //player win
            this.setState({
                result: "Win - Player has "+playerHandValue+" and dealer has "+dealerHandValue,
                dealerCard2: this.state.dealerHidden,
                gameState: 2
            })
            this.props.updateStats(1);
    ...
    calculatePlayerHand(){
        ...
        let playerHandArray = [this.state.playerCard1, this.state.playerCard2, this.state.playerCard3, this.state.playerCard4, this.state.playerCard5];
        
        playerHandArray.forEach((card) => {
            let cardValue = (card%13)+1;
            if (cardValue > 10){ //Face cards
                playerHandValue += 10
    ...
    calculateDealerHand(){
        ...
        let dealerHandArray = [this.state.dealerCard1, this.state.dealerHidden, this.state.dealerCard3, this.state.dealerCard4, this.state.dealerCard5];
        
        dealerHandArray.forEach((card) => {
            let cardValue = (card%13)+1;
            if (cardValue > 9){ //Face cards
                dealerHandValue += 10
            } else if (card%13 === 0){
                dealerHasAce = true;
        ...
        if (this.state.gameState===0){
            return(
                <div className="gamestartContainer"> 
                    <button className='actionbutton' id='gamestartbutton' onClick={this.handleStart}>Start New Game</button>
                </div>
            )
        }
            ...
            return (
                <div className="gameContainer">
                  ...
                  <div className="actioncontainer">
                      <button className="actionbutton" id="hitbutton" onClick={this.handleHit}>Hit</button>
                      <button className="actionbutton" id="staybutton" onClick={this.handleStay}>Stay</button>
                  </div>
            ...
            return (
                <div className="gameContainer">
                  ...
                  <div className="gameresults">
                      ...
                      <button className='actionbutton' id='restartbutton' onClick={this.handleStart}>Start New Game</button>
                  </div>
