...
class GameContainer extends Component {
  ...
  checkForWin() {
    ...
    for (let rowStart = 0; rowStart < 7; rowStart += 3) {
      if (
        gameBoard[rowStart] === gameBoard[rowStart + 1] &&
        gameBoard[rowStart + 1] === gameBoard[rowStart + 2] &&
        gameBoard[rowStart] !== ""
      ) {
    ...
    for (let column = 0; column < 3; column++) {
      if (
        gameBoard[column] === gameBoard[column + 3] &&
        gameBoard[column + 3] === gameBoard[column + 6] &&
        gameBoard[column] !== ""
      ) {
